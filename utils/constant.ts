...
export const ETHERSCAN_LOVE_LINK =
  `https://etherscan.io/address/${contractAddressLove}`;
export const ETHERSCAN_FARM_LINK =
  `https://etherscan.io/address/${contractAddressLoveFarm}`;

export const UNISWAP_LINK = `https://app.uniswap.org/#/add/v2/${contractAddressLove}/ETH`;
export const BIT_QUERY_LINK =
  `https://explorer.bitquery.io/ethereum/token/${contractAddressLove}`;
export const DEXSCREENER_LINK =
  `https://dexscreener.com/ethereum/${ETHLOVEPoolAddy}`;
...
export const LOVE_POOLS = [
  ...
  {
    name: "LOVE-WAR3",
    icon: "/assets/love_war.svg",
    token: contractAddressWar,
    baseAsset: contractAddressLove,
  },
];
