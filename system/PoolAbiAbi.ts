...
export interface PoolAbiAbiInterface extends utils.Interface {
  contractName: "PoolAbiAbi";
  functions: {
...
export interface PoolAbiAbi extends BaseContract {
  contractName: "PoolAbiAbi";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolAbiAbiInterface;
